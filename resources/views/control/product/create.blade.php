...
@section('title', 'Admin Dashboard | Yeni Məhsul')
@section('_scripts')
    <!-- Theme JS files -->
...
@section('_content')
    <div class="page-header page-header-light">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                <h4><span class="font-weight-semibold">Yeni Məhsul</span></h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Yeni Məhsul</span>
                </div>
    ...
    <div class="content">
        <form action="{{ route('system.product.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-group form-group-floating col-lg-12 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control form-control-outline @error('name') is-invalid @enderror" placeholder="Məhsul Adı">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="barcode" id="barcode" value="{{ old('barcode') }}" class="form-control form-control-outline @error('barcode') is-invalid @enderror" placeholder="Barkod">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="madeby" id="madeby" value="{{ old('madeby') }}" class="form-control form-control-outline @error('madeby') is-invalid @enderror" placeholder="İstehsalçı Ölkə">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="stok" id="stok" value="{{ old('stok') }}" class="form-control form-control-outline @error('stok') is-invalid @enderror" placeholder="Stok">
                                ...
                                <div class="position-relative">
                                    <select class="custom-select form-control-outline @error('category_id') is-invalid @enderror" name="category_id">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ $category->id == 1 ? 'selected' : null }}>{{ $category->name }} ({{ $category->parent->name }})</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="weight" id="weight" value="{{ old('weight') }}" class="form-control form-control-outline @error('weight') is-invalid @enderror" placeholder="Çəki">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="height" id="height" value="{{ old('height') }}" class="form-control form-control-outline @error('height') is-invalid @enderror" placeholder="Hünürlük">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="diameter" id="diameter" value="{{ old('diameter') }}" class="form-control form-control-outline @error('diameter') is-invalid @enderror" placeholder="Radius">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="volume" id="volume" value="{{ old('volume') }}" class="form-control form-control-outline @error('volume') is-invalid @enderror" placeholder="Sahə">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="keywords" id="keywords" value="{{ old('keywords') }}" class="form-control form-control-outline @error('keywords') is-invalid @enderror" placeholder="Meta Açar Sözlər">
