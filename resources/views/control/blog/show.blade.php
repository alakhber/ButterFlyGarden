...
@section('title', 'Admin Dashboard | '.$blog->name)
@section('_scripts')
    <!-- Theme JS files -->
    ...
    @include('control.blog._imgCheck')
@endsection
@section('_content')
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route('system.blog.index') }}" class="breadcrumb-item"> Bloglar</a>
    ...
    <div class="content">
        <form action="{{ route('system.blog.update',$blog) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <fieldset class="mb-3 row">
                        <legend class="text-uppercase font-size-sm font-weight-bold border-bottom">Blog Haqqında</legend>
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $blog->name }}" class="form-control form-control-outline @error('name') is-invalid @enderror" placeholder="Blog Adı">
                                    <label class="label-floating">Blog Adı</label>
                                </div>
                                @error('name')
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{ $blog->slug }}" class="form-control form-control-outline @error('slug') is-invalid @enderror" placeholder="Url">
                ...
                <div class="card-body">
                    <fieldset class="mb-3 row">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="title" id="title" value="{{ optional($blog->seo)->title }}" class="form-control form-control-outline @error('title') is-invalid @enderror" placeholder="Meta Title">
                        ...
                        <div class="form-group form-group-floating col-lg-6 ">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="keywords" id="keywords" value="{{ optional($blog->seo)->keywords }}" class="form-control form-control-outline @error('keywords') is-invalid @enderror" placeholder="Meta Açar Sözlər">
                        ...
                        <div class="form-group form-group-floating col-lg-12 ">
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <textarea class="form-control form-control-outline @error('description') is-invalid @enderror" name="description" id="description" placeholder="Meta Description">{{ optional($blog->seo)->description }}</textarea>
