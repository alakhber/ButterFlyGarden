...
@section('title', 'Admin Dashboard | Yeni Üzv')
@section('_scripts')
    <!-- Theme JS files -->
...
@section('_content')
    <div class="page-header page-header-light">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                <h4><span class="font-weight-semibold">Yeni Üzv</span></h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Yeni Üzv</span>
                </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('system.personal.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group form-group-floating col-lg-6 row">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="position" id="position" value="{{ old('position') }}" class="form-control form-control-outline @error('position') is-invalid @enderror" placeholder="Vəzifə">
                        ...
                        <div class="form-group form-group-floating col-lg-4 row">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="facebook" id="facebook" value="{{ old('facebook') }}" class="form-control form-control-outline @error('facebook') is-invalid @enderror" placeholder="Facebook">
                                    <label class="label-floating">Vəzifə</label>
                                </div>
                                @error('facebook')
                                    <span class="text-danger pl-2">{{ $message }}</span>
                        ...
                        <div class="form-group form-group-floating col-lg-4 row">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="linkedin" id="linkedin" value="{{ old('linkedin') }}" class="form-control form-control-outline @error('linkedin') is-invalid @enderror" placeholder="Linkedin">
                        ...
                        <div class="form-group form-group-floating col-lg-4 row">
                            <div class="col-lg-12">
                                <div class="form-group-feedback form-group-feedback-left">
                                    ...
                                    <input type="text" name="twitter" id="twitter" value="{{ old('twitter') }}" class="form-control form-control-outline @error('twitter') is-invalid @enderror" placeholder="Twitter">
                                    <label class="label-floating">Linkedin</label>
                                </div>
                                @error('twitter')
                                    <span class="text-danger pl-2">{{ $message }}</span>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    @error('image')
                                        <span class="text-danger pl-2">{{ $message }}</span>
                                    @enderror
                                    <input type="file" class="file-input @error('image')  is-invalid @enderror" name="image" data-show-caption="false" data-show-upload="false" data-fouc>
                                </div>
