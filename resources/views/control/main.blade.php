...
@section('_scripts')
    <script src="{{ _adminJs('demo_pages/dashboard.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/streamgraph.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/sparklines.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/lines.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/areas.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/donuts.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/bars.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/progress.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/heatmaps.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/pies.js')}}"></script>
    <script src="{{ _adminJs('demo_charts/pages/dashboard/light/bullets.js')}}"></script>
@endsection
@section('_content')
    <!-- Page header -->
