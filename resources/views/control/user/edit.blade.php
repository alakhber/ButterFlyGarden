...
@section('_content')
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('system.user.update', $user) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('Patch')
                        ...
                        <div class="form-group form-group-floating col-lg-12 row">
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <select class="custom-select form-control-outline" name="type">
                                        <option {{ $user->type == 'Super-Admin' ? 'selected' : null }} value="Super-Admin">Super Admin</option>
                                        <option {{ $user->type == 'Admin' ? 'selected' : null }} value="Admin">Admin</option>
                                        <option {{ $user->type == 'Moderato' ? 'selected' : null }} value="Moderator">Moderator</option>
                                        <option {{ $user->type == 'Sales-Manager' ? 'selected' : null }} value="Sales-Manager">Satış Meneceri</option>
                                    </select>
