            ...
            <div class="inner-title">
                ...
                <div class="banner-title">
                    ...
                    <div class="page-title-content link-style6">
                        ...
                        <span><a class="home" href="{{ route('services') }}">Xidmətlər</a></span>
                        <span class="page-title-content-inner">{{ $service->name }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                    ...
                    <div class="widget-nav-tab">
                        <ul class="tab-service link-style5">
                            @foreach ($services as $serv)
                                <li><a class="active" href="{{ route('service', $serv->slug) }}">{{ $serv->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                <div class="widget-contact-services-details mg-bottom-25">
                    ...
                    <ul class="widget-sidebar-contact-us text-pri2-color section-heading-rubik-size16">
                        <li><span class="icon-telephone">Tel:</span><span class="info-contact-us">{{ _contact('phone') }}</span></li>
                        <li><span class="icon-email">Email:</span><span class="info-contact-us">{{ _contact('email') }}</span></li>
                    </ul>
                </div>
            ...
            <div class="col-md-8">
                <article class="content-service-details">
                    ...
                    <div class="slickcorusel">
                        <div class="slider-for">
                            <div class="item">
                                ...
                                <img src="{{ _img($service->avatar) }}" alt="{{ $service->name }}" draggable="false" />
                                {{-- </a> --}}
                            </div>
                            @foreach ($service->gallery as $image)
                                <div class="item">
                                    <a data-fancybox="gallery" class="fancygallery" href="{{ _asset(_img($image->image)) }}">
                                        <img src="{{ _img($image->image) }}" alt="{{ $service->name }}" draggable="false" />
                                    </a>
                                </div>
                            @endforeach
                    ...
                    <div class="post-service-details bd-radius-8-image mg-bottom-45">
                        <img src="{{ _img($service->avatar) }}" style="width: 50%;display: block;margin: auto"  alt="{{ $service->name }}">
                    </div>
                @endif
                    <h2 class="section-heading-jost-size34 text-pri2-color mg-bottom30">{{ $service->name }}</h2>
